...
def line_equation(p1, p2):
    ...
    print (f"y = {M(p1, p2):.2f}x + {C(p1, p2):.2f}")
    return M(p1, p2), C(p1, p2)

@transform
def transformation_post_equation(p1, p2):
...
while True:
    try:
        ...
        p1,p2 = result_firstline_equation
        transformed_result = transformation_post_equation(point(*p1), point(*p2),result_firstline_equation)
